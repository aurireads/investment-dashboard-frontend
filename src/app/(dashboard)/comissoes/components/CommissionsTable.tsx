            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-left py-3 px-4 font-medium text-gray-700">Receita Líquida</th>
                  <th className="text-left py-3 px-4 font-medium text-gray-700">Comissão Total</th>
                  <th className="text-left py-3 px-4 font-medium text-gray-700">Meta</th>
                </tr>
              </thead>
              <tbody>
                {commissionsData.map((item, index) => (
                  <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-4 px-4 text-gray-900">{item.grossRevenue}</td>
